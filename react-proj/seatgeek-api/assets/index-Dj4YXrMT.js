      ...
      e: for (var W = 0, G = E.length, bt = G >>> 1; W < bt; ) {
        ...
        if (0 > l(gl, T))
          yn < G && 0 > l(er, gl)
            ? ((E[W] = er), (E[yn] = T), (W = yn))
            : ((E[W] = gl), (E[vn] = T), (W = vn));
        else if (yn < G && 0 > l(er, T)) (E[W] = er), (E[yn] = T), (W = yn);
        else break e;
      }
    }
    return z;
...
function $c(e, n, t, r, l, o, i, u, s) {
  (Et = !1), (jr = null), Fc.apply(Uc, arguments);
}
...
function hn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Es(Zo, hn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function ia(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (N === d.length) return t(f, _), U && gn(f, N), x;
    if (_ === null) {
      for (; N < d.length; N++)
        (_ = m(f, d[N], v)),
          _ !== null &&
  ...
  function k(f, a, d, v) {
    ...
    if (j.done) return t(f, _), U && gn(f, N), x;
    if (_ === null) {
...
function Ea(e, n, t) {
  return zn & 21
    ? (Oe(t, n) || ((t = Ns()), (A.lanes |= t), (Tn |= t), (e.baseState = !0)),
      n)
...
function td(e, n, t) {
  ...
  if (_a(e)) Na(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = ie()), Re(t, e, r, l), Pa(t, n, r));
  }
}
function _a(e) {
  var n = e.alternate;
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[go], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function wn(e, n, t) {
  var r = O,
    l = Ee.transition;
  try {
    (Ee.transition = null), (O = 1), wd(e, n, t, r);
  } finally {
    (Ee.transition = l), (O = r);
  }
  return null;
...
ys = _i;
gs = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, hs, vs, _i] },
  yt = {
...
function Rd() {
  return P.jsx("header", {
    children: P.jsx("h2", {
      className:
        "xl:text-4xl text-xl  bg-black xl:h-36 h-12 text-center xl:pt-12 p-2 font-bold text-red-400 ",
      children: "React - SeatGeek API",
    }),
  });
}
const tc =
  "https://www.ndv.co.il/react-proj/seatgeek-api/assets/seatgeek-def_280-210-BF3ktqAz.png";
async function Od() {
  const e = [];
  var n = new Headers();
  n.append(
  ...
  var t = { method: "GET", headers: n, redirect: "follow" };
  return (
    await fetch(
      ...
      .then((r) => r.text())
      .then((r) => {
        JSON.parse(r).taxonomies.forEach((o, i) => {
          e.push({
            id: o.id,
            idx: i,
            name: o.name,
            parent_id: o.parent_id,
            events: o.stats.event_count,
            perfomers: o.stats.performer_count,
            imgSrc: o.image ? o.image : tc,
          });
        });
      })
...
function Md({ data: e, filter: n, parentId: t }) {
  const r =
    ...
    o = "w-16 h-12 object-contain hidden xl:block";
  return P.jsxs("ul", {
    className:
      "flex flex-wrap text-sm font-medium text-center  border-b border-red-800 gap-2 xl:gap-0 ",
    children: [
      P.jsx("li", {
        className: "me-2",
        children: P.jsxs("button", {
          onClick: () => n(null),
          className: t === null ? r : l,
          children: [P.jsx("img", { src: tc, className: o }), "ALL"],
        }),
      }),
      e.map((i, u) =>
        P.jsx(
          "li",
          {
            className: "me-1 flex justify-items-center",
            children: P.jsxs("button", {
              onClick: () => n(i.id),
              "data-parent-id": i.id,
              className: t === i.id ? r : l,
              children: [P.jsx("img", { src: i.imgSrc, className: o }), i.name],
            }),
          },
          u
        )
...
function Dd({ data: e }) {
  return P.jsxs("section", {
    className:
      " flex flex-col p-2 m-2 xl:w-60 w-24 text-center bg-red-100 rounded-md text-black-200",
    children: [
      P.jsx("div", {
        ...
        children: P.jsxs("div", {
          ...
          children: [
            P.jsx("img", {
              src: e.imgSrc,
              className:
                "xl:w-64 xl:h-44 h-24 h-16 object-contain justify-center",
            }),
            P.jsx("span", {
              className:
                "xl:font-extrabold absolute top-2/3 xl:top-3/4 pl-3 left-0 text-white text-nowrap overflow-hidden truncate w-full text-left",
              children: e.name,
            }),
          ],
        }),
      ...
      P.jsxs("div", {
        className:
          "flex flex-col xl:flex-row justify-between gap-2 text-xs xl:text-lg",
        children: [
          P.jsxs("p", {
...
function Id({ data: e }) {
  ...
  return P.jsxs(P.Fragment, {
    children: [
      P.jsx("div", {
        className: "max-w-full flex flex-wrap justify-center bg-red-500",
        children: n && e.map((t, r) => P.jsx(Dd, { data: t }, r)),
      }),
      P.jsx("div", {
        className: "text-2xl text-center text-black  min-h-96",
        children:
          !n &&
          P.jsx("section", {
            className: "my-36",
            children: P.jsx("h2", { children: "No results " }),
          }),
      }),
    ],
  });
...
function Fd() {
  ...
  function o() {
    return [...e].filter((u) => t === u.parent_id || t === null);
  }
  return P.jsxs(P.Fragment, {
    children: [
      e.length === 0 &&
        P.jsx("p", {
          className: "mx-auto mt-8 font-extrabold",
          children: "Loading...",
        }),
      e.length > 0 &&
        P.jsxs("div", {
          ...
          children: [
            P.jsx(Md, {
              data: e.filter((i) => i.parent_id === null),
              filter: l,
              parentId: t,
            }),
            P.jsx(Id, { data: o() }),
...
function Ud({ data: e, navigate: n, menuTab: t }) {
  return P.jsxs(P.Fragment, {
    children: [
      P.jsx("h2", {
        className:
          "mb-8 font-bold tracking-wider uppercase md:text-lg text-red-400",
        children: "API List",
      }),
      P.jsx("ul", {
        className: "mt-8 xl:text-lg text-sm",
        children: e.map((r, l) =>
          P.jsx(
            "li",
            { children: P.jsx("button", { onClick: () => n(r), children: r }) },
            l
          )
        ),
      }),
...
function $d() {
  ...
  return P.jsxs(P.Fragment, {
    children: [
      P.jsx(Rd, {}),
      P.jsxs("main", {
        className: "h-screen xl:my-4 flex gap-2",
        children: [
          P.jsx("aside", {
            className:
              "xl:px-8 xl:py-16 py-1 px-2 bg-slate-900 text-cyan-50 rounded-r-lg w-1/3 xl:w-72",
            children: P.jsx(Ud, { data: e, navigate: r, menuTab: n }),
          }),
          P.jsx("div", {
            className: "w-2/3",
            children: n === "Taxonomies" && P.jsx(Fd, {}),
          }),
        ],
      }),
    ],
...
Ql.createRoot(document.getElementById("root")).render(
  P.jsx(kc.StrictMode, { children: P.jsx($d, {}) })
);
