...
function Rd() {
  return P.jsx("header", {
    children: P.jsxs("h2", {
      className:
        "text-4xl bg-black h-36 text-center pt-12 text-red-400 font-bold",
...
function Md({ data: e, filter: n, parentId: t }) {
  const r = "inline-block p-2 bg-red-500 text-black rounded-t-lg active  ",
    l = "inline-block p-2 rounded-t-lg  hover:bg-gray-800 hover:text-red-400  ",
    o = "w-16 h-12 object-contain ";
  return P.jsxs("ul", {
    className:
      "flex flex-wrap text-sm font-medium text-center  border-b border-red-800 ",
    children: [
      P.jsx("li", {
        className: "me-2",
...
function Dd({ data: e }) {
  return P.jsxs("section", {
    className:
      " flex flex-col p-2 m-2 w-60 text-center bg-red-100 rounded-md text-black-200",
    children: [
      P.jsx("div", {
        ...
        children: P.jsxs("div", {
          ...
          children: [
            ...
            P.jsx("span", {
              className:
                "font-extrabold absolute top-3/4 pl-3 left-0 text-white text-nowrap overflow-hidden truncate w-full text-left",
              children: e.name,
            }),
          ],
        }),
...
function $d() {
  ...
  return P.jsxs(P.Fragment, {
    children: [
      P.jsx(Rd, {}),
      P.jsxs("main", {
        className: "h-screen my-4 flex gap-2",
        children: [
          P.jsx("aside", {
            className:
              "px-8 py-16 bg-slate-900 text-cyan-50 rounded-r-lg w-1/3 md:w-72",
