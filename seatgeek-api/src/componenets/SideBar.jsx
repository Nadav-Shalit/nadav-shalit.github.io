export default function SideBar({ data, navigate, menuTab }) {
  const classesActive =
    "inline-block xl:p-4 bg-red-500 text-black rounded-t-lg active ";
  const classesInActive =
    "inline-block xl:p-4 rounded-t-lg  dark:hover:bg-gray-800 dark:hover:text-purple-300";
  ...
  return (
    <>
      ...
      <ul className="mt-8 xl:text-lg text-sm">
        {data.map((mnu, idx) => {
          return (
            <li key={idx}>
